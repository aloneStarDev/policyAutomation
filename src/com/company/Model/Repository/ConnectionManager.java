...
public class ConnectionManager implements AutoCloseable{
    ...
    public static Connection Startup(String username,String password){
        try {
            ...
            statement.execute("CREATE TABLE `policy`.`car` ( `id` INT NOT NULL AUTO_INCREMENT , `carTag` VARCHAR(7) NOT NULL , `ownerId` INT NOT NULL , `vin` VARCHAR(30) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
            statement.execute("CREATE TABLE `policy`.`certificate` ( `id` INT NOT NULL AUTO_INCREMENT , `ownerId` INT NOT NULL , `point` INT NOT NULL , `isActive` BOOLEAN NOT NULL , `penalty` BIGINT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
